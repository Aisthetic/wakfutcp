...
import com.github.jac3km4.wakfutcp.Protocol.Output.{CharacterSelectionMessage, ClientAuthenticationTokenMessage, ClientVersionMessage}
  ...
  def enterWorld(connection: ActorRef): Receive = {
    case Inbound(buf) =>
      ...
      id match {
        ...
        case 2050 =>
          import CharacterSelectionResultMessage._
